      ...
      return (
        <TouchableHighlight onPress={this._readLocal}>
          <View style={[styles.button, { backgroundColor: '#C5CAE9' }]}>
            <Text style={styles.buttonText}>Читать локально</Text>
          </View>
        </TouchableHighlight>
      )
    }
    ...
    if (isDownLoading) {
      return (
        <View style={styles.button}>
          <Text style={styles.buttonText}>Скачивание...</Text>
        </View>
      )
    }
        ...
        <View style={{ padding: 20 }}>
          ...
          <View style={styles.buttons}>
            <TouchableHighlight onPress={this._readOnline}>
              <View style={styles.button}><Text style={styles.buttonText}>Читать онлайн</Text></View>
            </TouchableHighlight>
